...
public class ControllerPessoas {
    ...
    public static boolean AtualizaNomeSocial(String NovoNome, String NomeAtual){
        String AtualizacaoSql = "UPDATE pessoa SET nome_social = '" +NovoNome+ "' WHERE nome_social = '" + NomeAtual + "'"; 
        //String pt1 = "SELECT * FROM pessoa WHERE 'nome_social' = 'Judite'";
        boolean r = database.ExecutaSQL(AtualizacaoSql); 
    ...
    public static boolean DeletarPessoa(String Nome){
        String AtualizacaoSql = "DELETE FROM pessoa WHERE nome_social = '" + Nome + "'"; 
        //String pt1 = "SELECT * FROM pessoa WHERE 'nome_social' = 'Judite'";
        boolean r = database.ExecutaSQL(AtualizacaoSql); 
